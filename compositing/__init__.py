...
# ── Hot-update sub-module ──────────────────────────────────────────────
# All _hot_* handlers + hot_update_property + hot_update_sun_direction
# live in compositing/hot_update.py. Re-exported here so external
# callers can keep using ``compositing.hot_update_property`` etc.
